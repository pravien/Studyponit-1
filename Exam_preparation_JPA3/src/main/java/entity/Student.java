...
@NamedQueries(
{
    ...
    @NamedQuery(name = "Student.amountOfStudentsForSemester", query = "SELECT count(s) FROM student s INNER JOIN semester k ON s.CURRENTSEMESTER_ID=k.id WHERE k.name= :name")
})
