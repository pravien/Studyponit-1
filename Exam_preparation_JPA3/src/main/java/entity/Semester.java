...
public class Semester implements Serializable
{
    ...
    private List<Teacher> teacherCollection = new ArrayList();
    @OneToMany(mappedBy = "currentsemesterId")
    private List<Student> studentCollection = new ArrayList();
    ...
    public void addTeacherCollection(Teacher teacher)
    {
        this.teacherCollection.add(teacher);
    }
    ...
    public void addStudentCollection(Student student)
    {
