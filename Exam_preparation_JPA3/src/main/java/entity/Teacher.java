...
public class Teacher implements Serializable
{
    ...
    @ManyToMany
    private List<Semester> semesterCollection = new ArrayList();
    ...
    @XmlTransient
    public List<Semester> getSemesterCollection()
    {
        return semesterCollection;
    }

    public void setSemesterCollection(Semester semesterCollection)
    {
        this.semesterCollection.add(semesterCollection);
    }
